...
class ClickhouseDtype(DTypeFunc, Enum):
    ...
    Enum8 = DTypeFunc("Enum8", Enum, read_enum, write_enum)
    Enum16 = DTypeFunc("Enum16", Enum, read_enum, write_enum)
    ...
    Nullable = DTypeFunc("Nullable", bool, read_nullable, write_nullable)
